...
class Read:
    ...
    def __init__(self, read, filename, meta=False):
        ...
        self.sample_id = tracking_id.get('sample_id', "None")
        ...
        #### [Mauricio] Added just to check vals 
        ...
        ### New position of return, to add more info to Read object, but before signal
        if self.meta:
            return
